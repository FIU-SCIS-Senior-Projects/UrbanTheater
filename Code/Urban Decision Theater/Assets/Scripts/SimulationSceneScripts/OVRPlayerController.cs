...
public class OVRPlayerController : MonoBehaviour
{
	...
	//to enable or disable mouse rotation
	...
	public virtual void UpdateMovement()
	{
		...
		ZoomAmount = Mathf.Min (Mathf.Abs (Input.GetAxis ("Mouse ScrollWheel")), MaxToClamp - Mathf.Abs (ZoomAmount));
		ZoomAmount *= ROTSpeed * Mathf.Sign (Input.GetAxis ("Mouse ScrollWheel"));
		MoveThrottle += ort * (new Vector3 (0, ZoomAmount, 0 )*transform.localScale.y);
		//if (Input.GetAxis ("Mouse ScrollWheel") > 0) {
			//curZoom += (40 *-1 * Input.GetAxis ("Mouse ScrollWheel"));
			//MoveThrottle += ort * (curZoom* Vector3.down*transform.lossyScale.y);
